...
// ===========================================================
public class MatchModifyAsync extends AsyncTask<String, Void, String> {

    ProgressDialog dialog;
    Activity mActivity;
    Context mContext;

    public MatchModifyAsync(Activity activity, Context context) {
        mActivity = activity;
        mContext = context;
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            HttpPost request = new HttpPost(Globale.webURL+Globale.MATCH+Globale.MODIFY);
