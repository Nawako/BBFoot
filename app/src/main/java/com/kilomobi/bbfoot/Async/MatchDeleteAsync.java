...
// ===========================================================
public class MatchDeleteAsync extends AsyncTask<String, Void, String> {

    ProgressDialog dialog;
    Activity mActivity;
    Context mContext;

    public MatchDeleteAsync(Activity activity, Context context) {
        mActivity = activity;
        mContext = context;
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            HttpPost request = new HttpPost(Globale.webURL+Globale.MATCH+Globale.DELETE);
